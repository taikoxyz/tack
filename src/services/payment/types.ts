 ...
 *
 * The reporting feature consumes this in app.ts's per-request middleware:
 * if all required reporting fields are present and the response is 2xx,
 ...
 *
 * The remaining reporting fields are OPTIONAL during the wiring transition.
 ...
 * reporting field is missing rather than rejecting the request — better
...
export interface PaymentResult {
  ...
  // Reporting fields (optional during transition; required-in-spirit
  // once T10 + T11 land).
  chainId?: number;
  amountAtomic?: string;
  amountUsd?: number;
